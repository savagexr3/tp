...
public class CommandTestUtil {
    ...
    public static final String VALID_COMPANY_AMY = "Bloomberg";
    public static final String VALID_COMPANY_BOB = "Singtel";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_REMARK_AMY = "Met during career fair";
    public static final String VALID_REMARK_BOB = "Love vibe coding!";
    ...
    public static final String VALID_LINK_AMY = "https://linkedin.com/in/amybee";
    public static final String VALID_LINK_BOB = "https://linkedin.com/in/bobchoo";
    ...
    public static final String INVALID_LINK_DESC = " " + PREFIX_LINK + "not-a-valid-link";

    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + "James&"; // '&' not allowed in names
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_COMPANY_DESC = " " + PREFIX_COMPANY + "Bl#omberg";
    public static final String INVALID_REMARK_DESC = " " + PREFIX_REMARK + "James/";
    ...
    static {
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withCompany(VALID_COMPANY_AMY)
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        CLinkedin expectedCLinkedin = new CLinkedin(actualModel.getCLinkedin());
        List<Person> expectedFilteredList = new ArrayList<>(actualModel.getFilteredPersonList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedCLinkedin, actualModel.getCLinkedin());
