...
<header sticky>
  <navbar type="dark">
    <a slot="brand" href="{{baseUrl}}/index.html" title="Home" class="navbar-brand">CLInkedin</a>
...
* [User Guide]({{ baseUrl }}/UserGuide.html) :expanded:
  ...
  * [Command Format]({{ baseUrl }}/UserGuide.html#command-format)
  * [Prefix Summary]({{ baseUrl }}/UserGuide.html#prefix-summary)
