...
3. The command can communicate with the `Model` when it is executed (e.g. to add the deleted person into the deleted person record and delete the person).<br>
